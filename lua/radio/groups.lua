...
M.setup = function()
	return {
		...
		Boolean = { fg = colors.med_pink },
		Float = { fg = colors.pale_orange },
		FloatBorder = { fg = colors.pale_orange },
		Operator = { fg = colors.med_pink },
		Keyword = { fg = colors.bright_pink },
		Keywords = { fg = colors.bright_pink },
		Identifier = { fg = colors.bright_pink },
		Function = { fg = colors.light_green },
		Statement = { fg = colors.bright_pink },
		Conditional = { fg = colors.bright_pink },
		Repeat = { fg = colors.bright_pink },
		Label = { fg = colors.yellow_white },
		Exception = { fg = colors.orange_pink },
		PreProc = { fg = colors.orange_yellow },
		Include = { fg = colors.dusky_pink },
		Define = { fg = colors.dusky_pink },
		Title = { fg = colors.pale_lavender },
		Macro = { fg = colors.dusky_pink },
		PreCondit = { fg = colors.dusky_pink },
		...
		["@punctuation.delimiter"] = { fg = colors.bright_pink },
